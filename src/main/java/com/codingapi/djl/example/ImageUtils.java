...
public class ImageUtils {
    ...
    public static void drawBoundingBoxes(float imageSize,BufferedImage image, DetectedObjects detections) {
        ...
        float fixW = imageWidth/imageSize;
        float fixH = imageHeight/imageSize;
        ...
        for (int i=0;i<list.size();i++) {
            ...
            int x = (int) (rectangle.getX()*fixW );
            int y = (int) (rectangle.getY()*fixH );
            g.drawRect(
                    x,
                    y,
                    (int) (rectangle.getWidth()*fixW ),
                    (int) (rectangle.getHeight()*fixH));
